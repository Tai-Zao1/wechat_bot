...
class MenuItems():
    def __init__(self):
        ...
        self.CopyMenuItem={'control_type':'MenuItem','auto_id':'XMenuItem','class_name':'mmui::XMenuView','found_index':0}#右键菜单里的复制消息
        ...
        self.ConvertVoiceToTextMenuItem={'title_re':'语音转文字|转为文字','control_type':'MenuItem'}#右键语音消息后的转文字选项
        ...
        self.CopyMenuItem={'control_type':'MenuItem','auto_id':'XMenuItem','class_name':'mmui::XMenuView','found_index':0}#主界面右键菜单里的复制选项
